...
@DisplayName("0. [Fidelidade] Especificação")
class FidelidadeEspecificacaoTest {

    @Test
    @DisplayName("0.1. Verificar se a classe 'Usuario' tem a anotação @Entity")
    ...
    @Test
    @DisplayName("0.2. Verificar se o atributo 'id' tem a anotação @Id")
    ...
    @Test
    @DisplayName("0.3. Verificar se o atributo 'id' tem a anotação @GeneratedValue com estratégia IDENTITY")
    ...
    @Test
    @DisplayName("0.4. Validar o atributo 'id'")
    void testAtributoId() {
        try {
            Field field = Usuario.class.getDeclaredField("id");
    ...
    @Test
    @DisplayName("0.5. Validar o atributo 'email'")
    ...
    @Test
    @DisplayName("0.6. Validar o atributo 'nome'")
    ...
    @Test
    @DisplayName("0.7. Validar o atributo 'cpf'")
    ...
    @Test
    @DisplayName("0.8. Validar o atributo 'senha'")
    ...
    @Test
    @DisplayName("0.9. Validar o atributo 'dataNascimento'")
